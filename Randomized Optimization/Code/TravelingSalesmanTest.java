...
public class TravelingSalesmanTest {
    ...
    public static void main(String[] args) {
        ...
        //for (int iter = 0; i < iterations.length;)
        ...
        for (int x = 0; x < temps.length; x++) {
            ...
            for (int y = 0; y < coolingRates.length; y++) {
                ...
                SimulatedAnnealing sa = new SimulatedAnnealing(temp, cooling, hcp);  //1E12, .95,
        ...
        for (int x = 0; x < populationRatios.length; x++) {
            ...
            for (int y = 0; y < mateRatios.length; y++) {
                ...
                for (int z = 0; z < mutateRatios.length; z++) {
                    ...
                    StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(population, mate, mutate, gap); // 200, 150, 20
        ...
        // for mimic we use asort encoding
